...
<body>
    <div class="container mt-4">
        ...
        <table cellpadding="10" class="table table-striped" style="border: solid 1px black;">
            <thead>
                <tr>
                    <th hidden>ลำดับ</th>
                    <th>รูปภาพ</th>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><img src='../assets/image_uploads/" . $row['inv_image'] . "' alt='Image' style='width: 100px; height: auto;'></td>";
                        echo "<td>" . $row['inv_number'] . "</td>";
                        echo "<td>" . $row['inv_name'] . "</td>";
                        echo "<td>" . $row['inv_type'] . "</td>";
                        echo "<td>" . $row['inv_unit'] . "</td>";
                        echo "<td>" . $row['inv_price'] . "</td>";
                        echo "<td>
